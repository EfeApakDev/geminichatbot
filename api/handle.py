"""
Telegram botu aracılığıyla gelen tüm sohbetler handle_message fonksiyonuna iletilir.
Bu fonksiyon, kullanıcının bot ile sohbet etmek için izinli olup olmadığını kontrol eder. İzin verildikten sonra, kullanıcının metin mi yoksa resim mi gönderdiğini belirler ve buna göre işlemler yapar.

Metin mesajları için, kullanıcının bu sohbetle ilgili tüm geçmişini takip eden ChatManager sınıfı devreye girer.

Resimler için ise, Gemini Pro'da bağlamdan bağımsız olduklarından, işlemleri oldukça doğrudan ve kolayca yapabilirsiniz.
"""
...
def handle_message(update_data):
    ...
    #    send_message(from_id, f"Bilgi gönderiminde bir hata oluştu. Lütfen aşağıdaki bilgileri bot yöneticisine iletin.\n您发送了一个未知事件，请把下面信息发送至bot管理员。\n\n{update_data}\n{e}")
    ...
    if update.type == "command":
        ...
        # reply_to_message_id parametresini kullanarak botun belirli bir resmi yanıtlamasını sağlayın.
